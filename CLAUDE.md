...
Marketing assets such as the store listing, feature graphic, icon and screenshots
...
2. A private backup repo: `C:\Projects\pictures\Sahi\` (the local clone of the
